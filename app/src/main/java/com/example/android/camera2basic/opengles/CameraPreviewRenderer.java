package com.example.android.camera2basic.opengles;
...
import com.example.android.camera2basic.Camera2BasicFragment_GLSurfaceView;
...
public class CameraPreviewRenderer implements GLSurfaceView.Renderer {
    ...
    Camera2BasicFragment_GLSurfaceView mCamera;
    ...
    public void init(GLSurfaceView surfaceView, Camera2BasicFragment_GLSurfaceView camera, boolean isPreviewStarted, Context context) {
        mContext = context;
