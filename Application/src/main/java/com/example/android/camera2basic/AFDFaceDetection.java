...
public class AFDFaceDetection {

	private AFD_FSDKEngine engine;

	// 用来存放检测到的人脸信息列表
	private List<AFD_FSDKFace> result;
	...
	public void process(byte[] data, int width, int height) {
		...
		//初始化人脸检测引擎，使用时请替换申请的APPID和SDKKEY
		//if (err == null) {
			err = engine.AFD_FSDK_InitialFaceEngine("Ayvv5KTpRdnao2zKtkZWVhXT1UmHM4ZGEL3BvdeKHDi","4Tg8Ah5djR5iVtDpj8XsvYJvePUC2nDu3jSCHuXMbUhW", AFD_FSDKEngine.AFD_OPF_0_HIGHER_EXT, 16, 5);
		//}
